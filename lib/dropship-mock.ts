...
export type SupplierListing = {
  ...
  /** What the supplier charges for shipping this item per delivery area —
   * a reseller needs this to know their real landed cost, not just the
   * wholesale price. Only set for locations in deliveryLocations. */
...
export const MOCK_SUPPLIER_LISTINGS: SupplierListing[] = [
  {
    ...
    deliveryFeeCents: { "Inside Dhaka": 7000, "Outside Dhaka": 13000 },
  ...
  },
  {
    ...
    image: null,
    deliveryLocations: ["Inside Dhaka", "Outside Dhaka"],
    deliveryFeeCents: { "Inside Dhaka": 6000, "Outside Dhaka": 12000 },
  ...
  },
  {
    ...
    image: null,
    deliveryLocations: ["Inside Dhaka"],
    deliveryFeeCents: { "Inside Dhaka": 8000 },
  ...
  },
  {
    ...
    image: null,
    deliveryLocations: ["Inside Dhaka", "Outside Dhaka"],
    deliveryFeeCents: { "Inside Dhaka": 6000, "Outside Dhaka": 11000 },
  ...
  },
  {
    ...
    image: null,
    deliveryLocations: ["Inside Dhaka"],
    deliveryFeeCents: { "Inside Dhaka": 9000 },
