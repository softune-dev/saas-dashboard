          ...
          {variant.values.map((v) => (
            ...
            >
              <input
                ...
                className="h-9 min-w-0 rounded-md border-0 bg-surface px-2.5 text-sm text-foreground outline-none ring-1 ring-border dark:ring-transparent focus:ring-primary"
              />
              <input
                type="number"
                step="0.01"
                ...
                placeholder="—"
                className="h-9 min-w-0 rounded-md border-0 bg-surface px-2.5 text-right text-sm tabular-nums text-foreground outline-none ring-1 ring-border dark:ring-transparent placeholder:text-muted-soft focus:ring-primary"
              />
              <button
                type="button"
                aria-label={`Remove ${v.value}`}
                onClick={() => removeValue(v.value)}
                className="inline-flex size-8 items-center justify-center rounded-md text-muted transition-colors hover:bg-surface hover:text-red-500"
              >
